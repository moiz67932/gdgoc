...
import { OrbitControls, useGLTF, useAnimations, Stage, PerspectiveCamera, Html, useProgress } from "@react-three/drei"
        ...
        <header className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-300 mt-2">Explore and animate 3D characters with interactive controls</p>
            </div>
            <Badge variant="outline" className="px-3 py-1 border-purple-500 bg-purple-500/10">
          ...
          >
            <CardContent className="p-0 h-full">
              ...
              <div className="absolute bottom-4 right-4">
                ...
                >
                  <RotateCw className={`h-4 w-4 ${autoRotate ? "text-purple-400 animate-spin" : "text-gray-400"}`} />
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-0">
                <Tabs defaultValue="controls" value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <TabsContent value="controls" className="p-6 space-y-4">
                    ...
                    <div className="mt-4 p-3 bg-purple-900/30 rounded-lg border border-purple-500/30">
                      <p className="text-sm text-purple-200">
                        ...
                        Currently playing: <span className="font-bold">{animation.toUpperCase()}</span> animation
                      </p>
                    </div>
                  </TabsContent>

                  <TabsContent value="characters" className="p-6">
                    <h2 className="text-2xl font-semibold mb-4 text-purple-300">Character Selection</h2>
                    <div className="grid grid-cols-1 gap-3">
                      {characters.map((char) => (
                        <Button
                          key={char.id}
                          onClick={() => setCharacter(char.url)}
                          variant={character === char.url ? "default" : "outline"}
                          className={
                            character === char.url
                  ...
                  <TabsContent value="info" className="p-6">
                    <h2 className="text-2xl font-semibold mb-4 text-purple-300">Instructions</h2>
                    ...
                    <div className="mt-6 p-4 bg-purple-900/30 rounded-lg border border-purple-500/30">
                      <h3 className="font-medium text-purple-300 mb-2">About This Demo</h3>
                      <p className="text-sm text-gray-300">
                        This interactive 3D character viewer demonstrates the capabilities of React Three Fiber and Drei
                        for creating immersive web experiences with 3D models and animations.
                      </p>
                    </div>
                  </TabsContent>
                </Tabs>
